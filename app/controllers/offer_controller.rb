class OfferController < ApplicationController
  ...
  post '/offer' do
    offer = Offer.create(
      ...
      comfortability_workinh_outside_location:params[comfortability_workinh_outside_location],
  ...
  patch '/offer' do
    offer = Offer.update(
      ...
      additionalqualification: params[:additionalqualification],
      location: params[:location],
      comfortability_working_outside_location:params[comfortability_working_outside_location],
      Languages:params[:Languages],
      workexperience:params[:workexperience],
      email:params[:email],
      phonenumber:params[:phonenumber],
